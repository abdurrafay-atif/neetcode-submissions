class Solution 
{
    public:
        ...
        // m = # of characters in t
        // time complexity: O(n), n = # of characters in s
        // space complexity: O(m), m = # of unique characters in t
        string minWindow(string s, string t) 
        {
            // build frequency map for string t
            // O(m) loop, n = # of characters in t
            ...
            unordered_map<char, int> smap;  // string s frequency map... O(m) worst case
            ...
            // O(n) loop, at most s[i] gets accessed twice for all i... 2 * n --> n
