class Solution 
{
    public:
        ...
        vector<int> indices;
        // variables for empty string edge cases
        ...
        string encode(vector<string>& strs) 
        {
            ...
            array_empty = false;
            // edge case 2: last string is empty
        ...
        {
            // edge case 1, array was empty, return empty array
            if(array_empty)
            {
                vector<string> res;
                return res;
            }
            // edge case 3, result string is empty
            // return all empty strings obtained
            if(s.length() == 0)
            {
                vector<string> res;
